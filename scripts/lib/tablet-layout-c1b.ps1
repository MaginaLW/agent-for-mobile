...
function Assert-TL1C1bBuildEnvironmentBinding {
    ...
    foreach($entry in @(
        ...
        [pscustomobject]@{Value=$Binding.debug_keystore;Keys=@('sha256','source_ordinary_single_link_guarded','isolated_copy_equal','isolated_user_home_other_config_absent','keystore_source_and_copy_deny_write_delete','directories_acl_protected','gradle_lock_precreated','gradle_lock_identity_guarded','gradle_lock_deny_delete','gradle_lock_write_allowed_during_gradle','post_gradle_lock_seal_required','post_gradle_lock_zero_length','post_gradle_lock_sealed_achieved');Name='build_environment/debug_keystore'},
    ...
    $requiredTrue=@(
        ...
        $Binding.debug_keystore.isolated_user_home_other_config_absent,
        $Binding.debug_keystore.keystore_source_and_copy_deny_write_delete,
        $Binding.debug_keystore.directories_acl_protected,$Binding.debug_keystore.gradle_lock_precreated,
        $Binding.debug_keystore.gradle_lock_identity_guarded,$Binding.debug_keystore.gradle_lock_deny_delete,
        $Binding.debug_keystore.gradle_lock_write_allowed_during_gradle,
        $Binding.debug_keystore.post_gradle_lock_seal_required,
        $Binding.debug_keystore.post_gradle_lock_zero_length,
        $Binding.debug_keystore.post_gradle_lock_sealed_achieved,
        $Binding.host_process.windows_system_directory_api_trust_root,
