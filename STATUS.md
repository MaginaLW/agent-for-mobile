...
- **手机 C 道已按用户 08-23 决定暂停；用户 08-24 再拍板 PA2553 / Android 16 / 日常横屏为平板设计与后续真机默认。** 手机批次 4 保持 0/4，八条替代 C 原样冻结。首份 T0 证据 `tablet-t0-20260823T162008Z-5e4e0186` 已入 main：1968×2800@400dpi；采集时横屏、Chrome 前台且有 pinned，故旧证据保持 inconclusive/blocked。T0-L 横屏离线候选已钉 `bc0076951828760355689fe9adbc8e1e1b654827`，24/24、runner 153/153；当前先离线完成横屏路线，不连接平板。行为不合 main，P0 在 T-L1 pane 探针与 T-L2 横屏策略前固定 unsupported。
