...
- 风险分级 / 任务级额度的 spec 起草——**实现前必须先走 B 道**，"哪些动作能进额度"是你的决定
...
| 问题 | 收敛到的选项 | 提出时间 |
|---|---|---|
| 通知栏审批卡片展示哪几项证据？现在确认卡有 8 项（前台 / 目标会话 / 焦点输入 / 焦点位置 / 明文预览 / 长度 / SHA-256 / 参数指纹），锁屏通知放不下全部；放少了削弱审批质量，放多了你根本不会读 | 待 A 道起草通知布局方案后收敛成 2–3 个选项 | 2026-08-01 |
